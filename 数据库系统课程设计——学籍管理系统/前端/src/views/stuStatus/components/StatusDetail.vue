<template>
  <div class="status-detail">
    <el-table :data="tableData" border class="container_wrap">
      ...
      <el-table-column prop="xueyuan" label="学院" width="180" align="center">
      </el-table-column>
      <el-table-column prop="classname" label="专业" width="180" align="center">
      </el-table-column>
      <el-table-column prop="stu_status" width="100" label="学籍状态" align="center">
      </el-table-column>
      <el-table-column prop="stu_reason" width="120" label="学籍变更原由" align="center">
      </el-table-column>
      <el-table-column
        prop="change_time"
